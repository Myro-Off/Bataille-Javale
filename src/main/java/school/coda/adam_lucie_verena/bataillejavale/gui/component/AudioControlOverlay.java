...
public class AudioControlOverlay extends HBox {
    ...
    public AudioControlOverlay() {
        ...
        getChildren().addAll(
                new VolumeControl(SVG_MUSIC, AssetsManager::getMusicVolume, AssetsManager::setMusicVolume, AssetsManager::toggleMusicMute, AssetsManager::isMusicMuted),
                new VolumeControl(SVG_SFX, AssetsManager::getSfxVolume, AssetsManager::setSFXVolume, AssetsManager::toggleSFXMute, AssetsManager::isSfxMuted)
        );
    }
